<template>
 <div class="casino">
   <h1>Welcome to the DiceGame</h1>
   <h4>Please pick a number between 1 and 6</h4>
   Amount to bet: <input v-model="amount" placeholder="0 Ether">
   <ul>
     <li v-on:click='clickNumber'>1</li>
     <br/><li v-on:click='clickNumber'>2</li>
     <br/><li v-on:click='clickNumber'>3</li>
    <li v-on:click='clickNumber'>4</li><br/>
    <br/><li v-on:click='clickNumber'>5</li><br/>
